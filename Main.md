...
- [Entity Framework](#entity-framework)
  * [Введение](#Введение)
    ...
    + [Подходы взаимодействия с базой данных](#Что такое Entity Framework)
  ...
  * [Использование Entity Framework в ASP.NET MVC](#Использование Entity Framework в ASP.NET MVC)
    + [Создание элементов](#Использование Entity Framework в ASP.NET MVC)
    + [Изменение сгенерированных форм](#Использование Entity Framework в ASP.NET MVC)
